...
<p> Do you want to contribute? Have a look at <a href="<?php echo surlencode('/development/introduction.html')?>">Development section</a> to join the <a href="https://codeberg.org/arianne/stendhal/src/commit/master/doc/contributors.md">List of contributors</a>.
<?php endBox();
	}
}
$page = new AboutPage();
